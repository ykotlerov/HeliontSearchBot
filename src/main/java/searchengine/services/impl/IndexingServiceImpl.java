...
public class IndexingServiceImpl implements IndexingService {
    ...
    public IndexResponse startIndexing() {
        ...
        Thread thread = new Thread(() -> {
            ...
            for (SiteCfg site : sitesList.getSites()) {
                EntitySite entitySite = getEntitySite(site, StatusType.INDEXING);
    ...
    public IndexResponse stopIndexing() {
        ...
        service.schedule(() -> {
            ...
            for (EntitySite entitySite : all) {
                if (entitySite.getStatus().equals(StatusType.INDEXING)) {
                    entitySite.setStatus(StatusType.FAILED);
    ...
    private EntitySite getEntitySite(SiteCfg site, StatusType status) {
    ...
    private void saveEntitySiteAndPage(SiteCfg site, String url, Document document) {
        EntitySite entitySite = getEntitySite(site, StatusType.INDEXED);
        repositorySite.saveAndFlush(entitySite);
